...
function Toast({ className, ...props }: ToastPrimitive.Root.Props) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
        "group/toast pointer-events-auto absolute right-0 top-0 z-[calc(1000-var(--toast-index))] w-full origin-top rounded-2xl border border-brand/15 bg-background/98 backdrop-blur-md text-foreground shadow-xl will-change-transform outline-none select-none focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50",
...
function ToastDescription({
  ...
  return (
    <ToastPrimitive.Description
      ...
      className={cn("text-[13px] text-muted-foreground break-all line-clamp-3", className)}
      {...props}
    />
  )
}
